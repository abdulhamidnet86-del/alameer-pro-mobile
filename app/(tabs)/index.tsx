...
const styles = StyleSheet.create({ content: { paddingTop: 8, paddingBottom: 110, gap: 10 }, topBar: { backgroundColor: "white", borderRadius: 22, padding: 10, flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", borderWidth: 1, borderColor: "#D6E1F5" }, topActions: { flexDirection: "row", gap: 5 }, iconButton: { width: 31, height: 31, borderRadius: 10, backgroundColor: "#F7FAFF", justifyContent: "center", alignItems: "center" }, brand: { alignItems: "center" }, brandBlue: { color: "#123F95", fontWeight: "900", fontSize: 18 }, brandRed: { color: "#E11D34", fontWeight: "900", fontSize: 18, position: "absolute", left: 58 }, sectionName: { color: "#102A62", fontSize: 11, marginTop: 2 }, online: { flexDirection: "row", alignItems: "center", backgroundColor: "#EDF9F0", borderRadius: 15, paddingHorizontal: 8, paddingVertical: 5 }, dot: { width: 8, height: 8, borderRadius: 8, backgroundColor: "#18A957", marginRight: 4 }, onlineText: { color: "#12833C", fontSize: 11, fontWeight: "700" }, refresh: { height: 34, borderRadius: 18, borderWidth: 1, borderColor: "#AFC8EE", backgroundColor: "#F0F6FF", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, refreshText: { color: "#183B82", fontSize: 12, fontWeight: "600" }, statusCard: { borderRadius: 19, padding: 12, backgroundColor: "#123DAD" }, statusHeader: { flexDirection: "row-reverse", alignItems: "center", gap: 10, marginBottom: 8 }, routerMark: { width: 42, height: 42, borderRadius: 12, backgroundColor: "#E21D36", alignItems: "center", justifyContent: "center" }, routerIp: { flex: 1, color: "white", fontSize: 18, fontWeight: "800", textAlign: "right" }, refreshCircle: { width: 38, height: 38, borderRadius: 19, backgroundColor: "#2073E5", justifyContent: "center", alignItems: "center" }, statusGrid: { flexDirection: "row", flexWrap: "wrap", gap: 7 }, stat: { width: "48%", borderRadius: 12, backgroundColor: "#194CC2", padding: 8, minHeight: 45 }, statLabel: { color: "#E1E9FF", fontSize: 10, textAlign: "right" }, statValue: { color: "white", fontSize: 12, fontWeight: "800", textAlign: "right" }, metricsRow: { flexDirection: "row-reverse", gap: 8 }, metric: { flex: 1, borderRadius: 16, backgroundColor: "white", borderWidth: 1, borderColor: "#C9D8F1", padding: 10, flexDirection: "row-reverse", alignItems: "center", gap: 8 }, metricIcon: { width: 35, height: 35, borderRadius: 12, backgroundColor: "#EDF4FF", alignItems: "center", justifyContent: "center" }, metricTitle: { color: "#163A85", fontSize: 11, textAlign: "right" }, metricValue: { color: "#102A62", fontSize: 16, fontWeight: "900", textAlign: "right" }, promo: { borderRadius: 18, backgroundColor: "#E11D34", padding: 10, flexDirection: "row-reverse", alignItems: "center", gap: 8 }, promoText: { flex: 1, textAlign: "center", color: "white", fontWeight: "800", fontSize: 14 }, promoButton: { backgroundColor: "#BF182E", borderRadius: 14, paddingHorizontal: 10, paddingVertical: 8, flexDirection: "row-reverse", gap: 4, alignItems: "center" }, promoButtonText: { color: "white", fontWeight: "800" }, heading: { color: "#102A62", fontSize: 24, fontWeight: "900", textAlign: "right", borderBottomWidth: 3, borderBottomColor: "#E11D34", alignSelf: "flex-end", paddingBottom: 3 }, grid: { flexDirection: "row-reverse", flexWrap: "wrap", gap: 9 }, service: { width: "31.5%", minHeight: 106, borderRadius: 18, backgroundColor: "white", borderWidth: 1.3, alignItems: "center", justifyContent: "center", padding: 7 }, serviceIcon: { width: 47, height: 47, borderRadius: 25, alignItems: "center", justifyContent: "center", marginBottom: 7 }, serviceText: { color: "#102A62", fontSize: 11, fontWeight: "800", textAlign: "center" }, bottomActions: { flexDirection: "row-reverse", gap: 9 }, bigAction: { flex: 1, borderRadius: 20, minHeight: 72, alignItems: "center", justifyContent: "center", flexDirection: "row-reverse", gap: 8 }, blueAction: { backgroundColor: "#135CDF" }, redAction: { backgroundColor: "#E11D34" }, bigActionText: { color: "white", fontSize: 14, fontWeight: "900" }, nav: { position: "absolute", bottom: 8, left: 10, right: 10, height: 68, borderRadius: 28, backgroundColor: "white", borderWidth: 1, borderColor: "#D4E1F5", flexDirection: "row-reverse", justifyContent: "space-around", alignItems: "center" }, navItem: { alignItems: "center", justifyContent: "center", minWidth: 45 }, navText: { color: "#14398C", fontSize: 10, marginTop: 2, fontWeight: "700" }, activeNav: { color: "#0B50C6" }, plus: { width: 60, height: 60, borderRadius: 30, backgroundColor: "#D9142B", alignItems: "center", justifyContent: "center", marginTop: -25, borderWidth: 5, borderColor: "#F7FAFF" } });

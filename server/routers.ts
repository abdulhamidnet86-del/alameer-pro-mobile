...
const dashboardToolSchema = z.enum(["ping", "interfaces", "ip-addresses", "dhcp-leases", "dhcp-server", "nat", "dns", "arp", "firewall-filter", "mangle", "layer7", "connections", "neighbors", "logs", "resources", "traffic", "routerboard", "device-health", "hotspot-users", "hotspot-active", "usermanager-users", "system-users", "queues"]);
